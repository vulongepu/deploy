...
class HTMLPageDirector extends AbstractPageDirector {
	...
	public function buildPage() {
		$this->builder->setTitle('Testing the HTMLPage 1111');
		$this->builder->setHeading('Testing the HTMLPage 22222');
...
writeIn('BEGIN TESTING BUILDER PATTERN');
writeIn('');
...
writeIn($page->showPage());
writeIn('');

writeIn('END TESTING BUILDER PATTERN');
